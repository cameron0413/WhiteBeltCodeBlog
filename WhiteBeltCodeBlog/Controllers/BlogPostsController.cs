...
namespace WhiteBeltCodeBlog.Controllers
{
    public class BlogPostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoryId,Title,Content,Created,LastUpdated,IsPublished,Slug,Abstract,IsDeleted,ImageData,ImageType")] BlogPost blogPost)
        {
